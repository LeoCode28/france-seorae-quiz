...
TRANSLATIONS = {
    'fr': {
        ...
        'welcome_subtitle': 'Parcours le quartier Seorae à Séoul et découvre la culture française à travers 30 plaques de rue.',
    ...
    'en': {
        ...
        'welcome_subtitle': 'Walk through Seorae Village in Seoul and discover French culture through 30 street plaques.',
    ...
    'ko': {
        ...
        'welcome_subtitle': '서울 서래마을을 걸으며 30개의 거리 표지판을 통해 프랑스 문화를 발견하세요.',
